...
def default_action ():
    ...
    myEngine.drawTriangles3D (cube, cube_idx, modelT, viewT, projectionT, 1.0, 0.0, 0.0)
    ...
    modelT = (myEngine.translate3D (2.0, 1.5, 0.0) @
              ...
              myEngine.rotateX (-30.0) @
              myEngine.scale3D (1.5, 1.5, 1.5))
    myEngine.drawTriangles3D (cylinder, cylinder_idx, modelT, viewT, projectionT, 0.0, 1.0, 0.0)
    ...
    myEngine.drawTriangles3D (sphere, sphere_idx, modelT, viewT, projectionT, 0.0, 1.0, 1.0)
    ...
    modelT = (myEngine.translate3D (2.0, -1.5, 0.0) @
              ...
              myEngine.rotateX (30.0) @
              myEngine.scale3D (1.5, 1.5, 1.5))
    myEngine.drawTriangles3D (cone, cone_idx, modelT, viewT, projectionT, 0.0, 0.0, 1.0)
